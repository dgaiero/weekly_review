...
def test_build_normalized_report(repo):
    ...
    assert report["efforts"][0]["update"]["sections"]["Accomplishments"] == (
...
def test_missing_update_warns_without_reusing_previous_week(repo):
    ...
    assert report["efforts"][0]["update"] is None
